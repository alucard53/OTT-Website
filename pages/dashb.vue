        ...
        <div class="flex flex-col bg-white rounded-md">
            ...
            <div class="flex flex-row">
                <div class="flex flex-col ml-5 mb-1">
                    ...
                    <span class="text-gray-500">{{ devices.substring(0, devices.length - 1) }}</span>
                </div>
            ...
            <div class="flex flex-row ml-5 mb-2">
                <button class=" border-solid border-2 border-blue-900 rounded-md text-blue-900 px-2 py-2">Cancel
                    Plan</button>
            </div>
        </div>
    </div>
