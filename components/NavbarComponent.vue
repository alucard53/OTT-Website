<template>
  <div class="navContainer">
    ...
    <div class="text-white flex gap-2">
      <div class="p-2 m-1" @click="handleSubmit"><h3>Home</h3></div>
      <div class="p-2 m-1" @click="handleSubmit"><h3>Movies</h3></div>
      <div class="p-2 m-1" @click="handleSubmit"><h3>Tv Shows</h3></div>
    </div>
